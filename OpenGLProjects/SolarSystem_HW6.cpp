...
void loadTexture() {
    //경로로 부터 이미지 파일 불러오기
    AUX_RGBImageRec* pEarthImage = auxDIBImageLoad("Data/Earth.bmp");
    AUX_RGBImageRec* pSunImage = auxDIBImageLoad("Data/Sun.bmp");
