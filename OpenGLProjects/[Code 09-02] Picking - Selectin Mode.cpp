...
{
	//from local to world coordinate
	glm::mat4 model(1.f);
	...
	//from world to view coordinate
	glm::mat4 view = glm::mat4(1.f);

	//from view to clip coordinate
	glm::mat4 projection;
	...
	//from clip to normalized coordinate
	convP = invM * p;
	convP /= convP[3];
...
void SelectObjects(GLint x, GLint y) {
	...
	glPushMatrix();
		...
		glLoadIdentity();
		//from viewport to normalized coordinate
		gluPickMatrix(x, viewport[3]-y, 2, 2, viewport);

		//from normalised coordinate to world coordinate
